...
\textbf{Revision:} We expanded the Data Availability and Reproducibility Statement. It now specifies the public repository, the Zenodo concept DOI, the first release DOI, and the types of released materials, including scripts, protocols, figures, and releasable benchmark resources.
